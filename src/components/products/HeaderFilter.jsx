...
getFilters()
  ...
  return (
    <div className=" mb-4 w-full">
      <div className="items-center justify-between  px-3 py-2 bg-gray-color md:flex border border-gray-200 dark:border-gray-900 dark:bg-gray-800 dark:shadow-md rounded-md">
        <div className=" hidden md:flex justify-start">
          <span
            onClick={selecteGrid}
            className="inline-block cursor-pointer h-full p-2 mr-3 border rounded-md bg-btn-color2 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700"
          >
            <svg
